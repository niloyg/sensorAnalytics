...
public class LDA {
	...
	/* Calculates a linear discriminant analysis (LDA) with all necessary data
	   The data as double array. The array must have the same size as the group array
	   if p is Set to true, if the probability estimation should be based on the real
	   group sizes (true), or if the share of each group should be equal */
	...
	public static void main(String[] args) {
		...
		double[][] data = { { 2.95, 6.63, 1.12 }, { 2.53, 7.79, 1.00 }, { 3.57, 5.65, 2.08 },
				{ 3.16, 5.47, 2.04 }, { 2.58, 4.46, 3.18 }, { 2.16, 6.22, 3.66 }, { 3.27, 3.52, 3.84 } };

		LDA test = new LDA(data, group, true);
		double[] testData = { 2.81, 5.46, 10.34 };
